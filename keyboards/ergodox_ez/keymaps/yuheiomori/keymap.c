...
[MAC] = KEYMAP(
        ...
        KC_TAB,         KC_Q,         KC_W,       KC_E,    KC_R,   KC_T,   LGUI(LSFT(KC_PGUP)),
        ...
        LGUI(LSFT(KC_PGDOWN)),          KC_Y,         KC_U,       KC_I,    KC_O,    KC_P,             KC_MINS,
...
/* Keymap 4: Ubuntu function Layer
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
...
[UBUNTUFN] = KEYMAP(
       ...
       KC_TRNS,   KC_TRNS,  KC_7,    KC_8,    KC_9,    KC_TRNS ,  KC_LANG2,
                KC_TRNS,  KC_4,    KC_5,    KC_6,    KC_TRNS,   KC_TRNS,
       KC_TRNS,   KC_TRNS,  KC_1,    KC_2,    KC_3,    KC_TRNS,   KC_TRNS,
                KC_0,   KC_TRNS,  KC_TRNS,    KC_TRNS,   TO(MOUSE),
       KC_TRNS,   KC_MUTE,
