...
[MAC] = KEYMAP(
        ...
        KC_TAB,         KC_Q,         KC_W,       KC_E,    KC_R,   KC_T,   KC_NO,
        KC_LCTL,        KC_A,         KC_S,       KC_D,    KC_F,   KC_G,
        KC_LSFT,        CTL_T(KC_Z),  KC_X,       KC_C,    KC_V,   KC_B,   MO(MACFN),
        ...
        MO(MACFN),      KC_N,         KC_M,       KC_COMM, KC_DOT,  CTL_T(KC_SLSH),   SFT_T(KC_BSLS),
...
[UBUNTUFN] = KEYMAP(
       ...
       KC_TRNS, KC_P7,   KC_P8,   KC_P9,   KC_PAST,  KC_TRNS, KC_TRNS,
                KC_P4,   KC_P5,   KC_P6,   KC_PSLS,  KC_TRNS, KC_TRNS,
       KC_TRNS, KC_P1,   KC_P2,   KC_P3,   KC_PMNS,  KC_TRNS, KC_TRNS,
                KC_P0,   KC_TRNS, KC_PDOT, KC_PPLS,  TO(MOUSE,1),
       KC_TRNS, KC_MUTE,
       KC_TRNS,
...
[MOUSE] = KEYMAP(
       ...
       TO(UBUNTU,1),  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,  KC_TRNS, KC_TRNS,
